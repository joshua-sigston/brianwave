    ...
    return (
      ...
      className={
        `inline-flex w-full items-center justify-center rounded-xl px-4 py-2.5 text-sm font-medium
         ...
         transition focus:outline-none focus:ring-2 focus:ring-green-400/70
         ${pending ? 'bg-blue-300/70 cursor-not-allowed' : 'bg-emerald-400 hover:bg-green-500'} ` + className
      }
    >
      {pending && (
